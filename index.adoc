...
. Run the quantification for all samples using a loop. This will take about 
+
[source,sh]
----
...
[source,sh]
----
mkdir /mnt/c/Documents\ and\ Settings/IAMZ/desktop/3drna
cp -t /mnt/c/Documents\ and\ Settings/IAMZ/desktop/3drna sample_info.csv transcript_genes.csv kallisto.zip
----
